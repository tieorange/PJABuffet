...
public class AdapterMenu extends RecyclerView.Adapter<AdapterMenu.ViewHolderMenuItem> {
  ...
  public class ViewHolderMenuItem extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.cancel) ImageButton mCancel;
    @BindView(R.id.revealView) View mRevealView;
    ...
    private void zeroAmount() {
      ...
      circularReveal(CartTools.getCurrentAmount(ProductsTools.getProduct(getAdapterPosition())),
          true, mContext);
    }
